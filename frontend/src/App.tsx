  ...
  const handleAuthSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (authMode === 'register') {
        ...
        setAuthSuccess('Ma OTP da duoc gui. Goi y mock: 123456');
        setAuthMode('otp');
        return;
      }
            ...
            <div className="auth-card card-glass">
              ...
              <form className="auth-form" onSubmit={handleAuthSubmit}>
                ...
                {authMode !== 'otp' ? (
                  ...
                  <div className="form-group">
                    <label>Ma OTP</label>
                    <input value={otpCode} onChange={(event) => setOtpCode(event.target.value)} maxLength={6} required />
                    <span className="hint-label">Ma OTP mock: <code>123456</code></span>
                  </div>
                )}
