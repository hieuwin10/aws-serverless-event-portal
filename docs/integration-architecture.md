...
graph TD
    ...
    Lambda -.->|10. Xuất log hoạt động| CW[Amazon CloudWatch <br/> Logs]
...
*   **Cấu hình Free Tier:** **1,000,000** lượt gọi và **3.2 triệu giây** tính toán miễn phí mỗi tháng (với cấu hình ram 128MB).
